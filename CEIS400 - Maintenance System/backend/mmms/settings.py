"""
Django settings for mmms project.
...
SECRET_KEY = 'django-insecure-hbh@2mkj%q=jc)wyfcoa05e$-$qc4pxd^67w^3&bsfz1z+(l)i'
...
WSGI_APPLICATION = 'mmms.wsgi.application'
...
# CORS - allow the Vite dev server (and its proxy) to call this API
...
# Django REST Framework - use JWT for the React frontend
REST_FRAMEWORK = {
